...
#ifdef ADVANCEDGL
#ifdef FULLSCREEN
	window = SDL_CreateWindow(GameName, 100, 100, ScreenWidth, ScreenHeight, SDL_WINDOW_FULLSCREEN|SDL_WINDOW_OPENGL );
#else
	window = SDL_CreateWindow(GameName, 100, 100, ScreenWidth, ScreenHeight, SDL_WINDOW_SHOWN|SDL_WINDOW_OPENGL );
#endif
...
#else
#ifdef FULLSCREEN
	window = SDL_CreateWindow(GameName, 100, 100, ScreenWidth, ScreenHeight, SDL_WINDOW_FULLSCREEN );
#else
